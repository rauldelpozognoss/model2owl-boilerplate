...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
    ...
    <xsl:variable name="base-ontology-uri" select="'http://hari-meta.org/ontology/hari'"/>
    <xsl:variable name="base-shape-uri" select="'http://hari-meta.org/data-shape/hari'"/>
    ...
    <!--
		Para añadir estereotipos, añadirlos a esta línea separados por coma select="('Abstract', 'Dominio')
	-->
    ...
    <xsl:variable name="includedPrefixesList" select="('hari')"/>
